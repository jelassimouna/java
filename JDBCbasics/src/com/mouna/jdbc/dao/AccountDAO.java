...
public class AccountDAO {
	public static void main(String[] args) {
		try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost/mydb", "lina", "lina@je22");
...

		{
			...
			// int result = statement.executeUpdate("insert into account values(1,'jelassi',
			// 'mouna',1000)");
